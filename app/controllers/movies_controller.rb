class MoviesController < ApplicationController
  ...
  def index
    ...
    # a boolean to prevent redirect loops on the initial use
    nosession = (session[:sortedby] == nil) and (session[:ratings] == nil)
    ...
    flash.keep if ((params[:sortedby] == nil) or (params[:ratings] == nil)) and !nosession
    redirect_to movies_path(:sortedby => session[:sortedby], :ratings => session[:ratings_boxes]) if 
       ((params[:sortedby] == nil) or (params[:ratings] == nil)) and !nosession
